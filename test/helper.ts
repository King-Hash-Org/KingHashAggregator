...
async function prepareTrade(
    ...
    return "0x" + strategy + remove0xPrefix(sigBreakdown.v.toString(16)) + padding
...
async function eth32RouteData(wallet: SignerWithAddress): Promise<String> {
    ...
    const depositData: DepositData = {
        ...
        signature: "0xa9e48de9f5bf75fbc9847d2ffa51be36a8377cce0509f83a05bcb7b4507668d665d2e25309ed9880f57ba372b87c3e5817fb8ce289e0a22c655762145c0300d00afe9ebf83ccbd54e8110ad5980f67165fd26d290b9aa50f0f7c49619d587196",
