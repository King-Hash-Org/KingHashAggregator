...
describe("NodeRewardVault", function () {
    ...
    describe("Authority setting", function () {
        ...
        it("Should revert & not set the authority", async function () {
            ...
            await expect(nodeRewardVault.connect(otherAccount).setAuthority(otherAccount.address)).to.be.revertedWith("Ownable: caller is not the owner");
        });
    });
    ...
    describe("Aggregator settings", function () {
        ...
        it("Should revert & not set the aggregator", async function () {
            ...
            await expect(nodeRewardVault.connect(otherAccount).setAggregator(otherAccount.address)).to.be.revertedWith("Ownable: caller is not the owner");
        });
    });
    ...
    describe("DAO settings", function () {
        ...
        it("Should revert & not set the DAO address", async function () {
            ...
            await expect(nodeRewardVault.connect(otherAccount).setDao(otherAccount.address)).to.be.revertedWith("Ownable: caller is not the owner");
        });
    });
    ...
    describe("Comission settings", function () {
        ...
        it("Should revert & not set the comission", async function () {
            ...
            await expect(nodeRewardVault.connect(otherAccount).setComission(999)).to.be.revertedWith("Ownable: caller is not the owner");
    ...
    describe("Transfer and rewards", function () {
        ...
        it("Should not be able to transfer", async function () {
            ...
            await expect(nodeRewardVault.transfer(ethers.utils.parseEther("100"), owner.address)).to.be.revertedWith("Not allowed to touch funds");
        });
