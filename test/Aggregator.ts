...
describe("Aggregator", function () {
  ...
  async function deployBaseFixture() {
    ...
    // await aggregator.initialize(false, depositContract.address, nodeRewardVault.address, nftContract.address, lidoContract.address , lidoController.address, rocketDepositPoolContract.address, rocketController.address , rocketTokenRETH.address);
  ...
  describe("Testing for Rocket Stake", function () {
    ...
    it("Correct data behaviour for Rocket Stake", async function () {
      ...
      const data = "0x040000000000000000000000000000000000000000000000001BC16D674EC80000";
      // Test  Rocket Stake Router
      await expect(aggregator.stake([data])).to.be.revertedWithoutReason();
      expect(await aggregator.callStatic.stake([data], { value: ethers.utils.parseEther("2")})).to.be.equal(true);
    ...
    it("Less than minimum stake behaviour for Rocket Stake", async function () {
      ...
      const data = "0x0400000000000000000000000000000000000000000000000000038D7EA4C68000";
      // Test  Rocket Stake Router
